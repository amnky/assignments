...
import com.techlabs.ocp.solution.model.CalculateInterest;
import com.techlabs.ocp.solution.model.DetailPrinter;
...
public class FixedDepositTest {
	...
	public static void main(String[] args) {
		...
		CalculateInterest calculateInterest = new CalculateInterest(fixedDeposit);

		DetailPrinter detailPrinter = new DetailPrinter(fixedDeposit, calculateInterest);
